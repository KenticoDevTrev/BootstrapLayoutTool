...
public class BootstrapTwoColumnFormSectionController : Controller
{
    ...
    {
        return PartialView("~Views/Shared/FormSections/_BootstrapTwoColumnFormSection.cshtml");
    }
}
public class BootstrapTwoColumn2575FormSectionController : Controller
{
    ...
    public ActionResult Index()
    {
        return PartialView("~Views/Shared/FormSections/_BootstrapTwoColumn2575FormSection.cshtml");
    }
}
public class BootstrapTwoColumn7525FormSectionController : Controller
{
    ...
    public ActionResult Index()
    {
        return PartialView("~Views/Shared/FormSections/_BootstrapTwoColumn7525FormSection.cshtml");
    }
}
public class BootstrapTwoColumn3366FormSectionController : Controller
{
    ...
    public ActionResult Index()
    {
        return PartialView("~Views/Shared/FormSections/_BootstrapTwoColumn3366FormSection.cshtml");
    }
}
public class BootstrapTwoColumn6633FormSectionController : Controller
{
    ...
    public ActionResult Index()
    {
        return PartialView("~Views/Shared/FormSections/_BootstrapTwoColumn6633FormSection.cshtml");
    }
}
public class BootstrapThreeColumnFormSectionController : Controller
{
    ...
    public ActionResult Index()
    {
        return PartialView("~Views/Shared/FormSections/_BootstrapThreeColumnFormSection.cshtml");
    }
}
public class BootstrapFourColumnFormSectionController : Controller
{
    ...
    public ActionResult Index()
    {
        return PartialView("~Views/Shared/FormSections/_BootstrapFourColumnFormSection.cshtml");
    }
}
public class BootstrapFiveColumnFormSectionController : Controller
{
    ...
    public ActionResult Index()
    {
        return PartialView("~Views/Shared/FormSections/_BootstrapFiveColumnFormSection.cshtml");
    }
}
public class BootstrapSixColumnFormSectionController : Controller
{
    ...
    public ActionResult Index()
    {
        return PartialView("~Views/Shared/FormSections/_BootstrapSixColumnFormSection.cshtml");
    }
}