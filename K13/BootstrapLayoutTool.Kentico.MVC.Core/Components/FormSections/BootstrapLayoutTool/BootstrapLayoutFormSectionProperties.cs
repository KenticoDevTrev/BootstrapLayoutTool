...
[assembly: RegisterFormSection(Bootstrap4LayoutToolFormSectionProperties.IDENTITY, "Bootstrap 4 Layout", Bootstrap4LayoutToolFormSectionProperties.VIEWPATH, PropertiesType = typeof(Bootstrap4LayoutToolFormSectionProperties), Description = "Allows you to add a Bootstrap 4 Section with fully configurable layout", IconClass = "icon-l-cols-25-50-25")]
namespace BootstrapLayoutTool
{
    public class Bootstrap4LayoutToolFormSectionProperties : IFormSectionProperties
    {
        public const string IDENTITY = "Bootstrap4LayoutToolFormSection";
        public const string VIEWPATH = "~/Views/Components/FormSections/BootstrapLayoutTool/_Bootstrap4LayoutToolFormSection.cshtml";
...
none;None";
        ...
        public Bootstrap4LayoutToolFormSectionProperties()
        {
        }
...
Remove Gutters: no-gutters;")]
        ...
        [EditingComponent(TextAreaComponent.IDENTIFIER, Order = 28, Label = "Html Before Section", Tooltip = "Places Html before the sections content")]
        public string HtmlBefore { get; set; }

        [EditingComponent(TextAreaComponent.IDENTIFIER, Order = 29, Label = "Html After Section", Tooltip = "Places Html after the sections content")]
