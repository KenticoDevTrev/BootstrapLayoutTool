...
[assembly: RegisterSection(Bootstrap5LayoutToolProperties.IDENTITY, "Bootstrap 4 Layout", propertiesType: typeof(Bootstrap5LayoutToolProperties), customViewName: Bootstrap5LayoutToolProperties.VIEWPATH, Description = "Allows you to add a Bootstrap 4 Section with fully configurable layout", IconClass = "icon-l-cols-25-50-25")]

namespace BootstrapLayoutTool
{
    public class Bootstrap5LayoutToolProperties : ISectionProperties
    {
