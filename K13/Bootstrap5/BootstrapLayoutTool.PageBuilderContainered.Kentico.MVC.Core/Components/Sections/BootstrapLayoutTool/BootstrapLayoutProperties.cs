...
[assembly: RegisterSection(Bootstrap5LayoutToolProperties.IDENTITY, "Bootstrap 5 Layout", propertiesType: typeof(Bootstrap5LayoutToolProperties), customViewName: Bootstrap5LayoutToolProperties.VIEWPATH, Description = "Allows you to add a Bootstrap 5 Section with fully configurable layout", IconClass = "icon-l-cols-25-50-25")]

namespace BootstrapLayoutTool
{
    public class Bootstrap5LayoutToolProperties : PageBuilderWithHtmlBeforeAfterSectionProperties, ISectionProperties
    {
        public const string IDENTITY = "Bootstrap5LayoutTool";
        public const string VIEWPATH = "~/Views/Components/Sections/BootstrapLayoutTool/_Bootstrap5LayoutTool.cshtml";
...
col-xxl;Extra extra large (1400px)";
        ...
        public Bootstrap5LayoutToolProperties()
        {
        }
